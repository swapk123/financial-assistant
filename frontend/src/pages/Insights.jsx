...
const Insights = () => {
  ...
  const getHealthScore = (spending) => {
    if (spending < 300) return { score: 85, label: 'Excellent', status: 'excellent' };
  ...
  if (!insights?.insights?.total_transactions || insights.insights.total_transactions === 0) {
    return (
      <div className="insights-container">
        <div className="main-content">
          ...
          <div className="insights-empty-state">
            ...
            <p className="insights-empty-description">
              Add some transactions to unlock powerful AI insights and recommendations for your financial health.
            </p>
  ...
  const categoryData = Object.entries(data.spending_by_category || {}).map(([category, amount]) => ({
    category,
    amount,
    ...
    <div className="insights-container">
      <div className="main-content">
        ...
        <div className="insights-stats-grid">
          ...
          <div className="insight-stat-card fade-in-up" style={{animationDelay: '0.1s'}}>
            <div className="insight-stat-content">
              <div className="insight-stat-info">
          ...
          <div className="insight-stat-card fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="insight-stat-content">
              <div className="insight-stat-info">
          ...
          <div className="insight-stat-card fade-in-up" style={{animationDelay: '0.3s'}}>
            <div className="insight-stat-content">
              <div className="insight-stat-info">
        ...
        <div className="insights-content-grid">
              ...
              {categoryData.map((item, index) => (
                ...
                >
                  <div className="category-info">
                    <div 
                      className={`category-color ${getCategoryColor(item.category)}`}
                      style={{ '--category-color': `var(--${getCategoryColor(item.category)})` }}
                    ></div>
                      ...
                      <div className="category-bar">
                        <div 
                          ...
                          style={{ 
                            ...
                            backgroundColor: `var(--${getCategoryColor(item.category)})`
                          }}
                        ></div>
                      </div>
                    </div>
          ...
          {/* AI Recommendations */}
          <div className="recommendations-card slide-in-right" style={{animationDelay: '0.1s'}}>
              ...
              <div className="health-metrics">
                <div className="health-metric">
                  ...
                  <span className="metric-value">
                    {data.total_spending < 500 ? 'Excellent' : data.total_spending < 1000 ? 'Good' : 'Needs Work'}
                  </span>
                  <span className={`metric-status ${
                    data.total_spending < 500 ? 'excellent' : data.total_spending < 1000 ? 'good' : 'poor'
                  }`}>
                    {data.total_spending < 500 ? 'A+' : data.total_spending < 1000 ? 'B' : 'C'}
                  </span>
                </div>
                <div className="health-metric">
                ...
                <div className="health-metric">
                  ...
                  <span className="metric-value">
                    {data.savings_rate >= 20 ? 'Excellent' : data.savings_rate >= 10 ? 'Good' : 'Low'}
                  </span>
                  <span className={`metric-status ${
                    data.savings_rate >= 20 ? 'excellent' : data.savings_rate >= 10 ? 'good' : 'poor'
                  }`}>
                    {data.savings_rate >= 20 ? 'A' : data.savings_rate >= 10 ? 'B' : 'D'}
                  </span>
                </div>
              </div>
            </div>
